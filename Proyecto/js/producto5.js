...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../imagenes/i5-11400-${event.target.id}.jpg')`
...
modalthumbnails.forEach(modalthumbnail => {
    modalthumbnail.addEventListener('click', event=>{
        ...
        modalImageContainer.style.backgroundImage = `url('../imagenes/i5-11400-${event.target.id.slice(-1)}.jpg')`
    });
});
...
function drawProductInModal(){
    ...
    `<div class="cart-modal__details-container">
            <img class="cart-modal__image" src="../imagenes/i5-11400-1.jpg" alt="">
            <div>
            <p class="cart-modal__product">Procesador Intel® Core...</p>
            <p class="cart-modal__price">S/895 x3</p>
            </div>
    ...
    deleteProduct()
    let priceModal = document.querySelector('.cart-modal__price');
    priceModal.innerHTML = `S/895 x${lastValue}-<span>S/${lastValue*895}.00</span>`;
}
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('../imagenes/i5-11400-${imgIndex}.jpg')`
}
