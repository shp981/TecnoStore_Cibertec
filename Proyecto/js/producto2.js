...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../imagenes/teros-${event.target.id}.jpg')`
    });
});
...
modalthumbnails.forEach(modalthumbnail => {
    modalthumbnail.addEventListener('click', event=>{
        ...
        modalImageContainer.style.backgroundImage = `url('../imagenes/teros-${event.target.id.slice(-1)}.jpg')`
    });
});
...
function drawProductInModal(){
    ...
    `<div class="cart-modal__details-container">
            <img class="cart-modal__image" src="../imagenes/teros-1.jpg" alt="">
            <div>
            <p class="cart-modal__product">Monitor Curvo...</p>
            <p class="cart-modal__price">S/600 x3</p>
            </div>
    ...
    deleteProduct()
    let priceModal = document.querySelector('.cart-modal__price');
    priceModal.innerHTML = `S/600 x${lastValue}<span>S/${lastValue*600}.00</span>`;
}
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('../imagenes/teros-${imgIndex}.jpg')`
}
