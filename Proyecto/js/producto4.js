...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../imagenes/RTX-2060-${event.target.id}.jpg')`
...
function drawProductInModal(){
    ...
    `<div class="cart-modal__details-container">
            <img class="cart-modal__image" src="../imagenes/RTX-2060-1.jpg" alt="">
            <div>
            <p class="cart-modal__product">MSI RTX 2060 SUPER VENTUS...</p>
            <p class="cart-modal__price">S/875 x3</p>
            </div>
    ...
    deleteProduct()
    let priceModal = document.querySelector('.cart-modal__price');
    priceModal.innerHTML = `S/875 x${lastValue}-<span>S/${lastValue*875}.00</span>`;
}
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('../imagenes/RTX-2060-${imgIndex}.jpg')`
}
